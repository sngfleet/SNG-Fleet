...
import safeguard from "../assets/clients/safeguard.jpg"
import liveTimes from "../assets/clients/live_times.png"
      ...
      <div className="section-band">
        <section style={{ padding: "40px 20px" }}>
          ...
          <div className="client-logos">
            ...
            <div className="logo-box"><img src={liveTimes} alt="LiveTimes" /></div>
            <div className="logo-box republic-logo"><img src={republic} alt="Republic Network" /></div>
            <div className="logo-box"><img src={ukg} alt="UKG" /></div>
            <div className="logo-box"><img src={safeguard} alt="Safeguard" /></div>
